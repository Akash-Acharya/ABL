...
PROCEDURE PrintOrderAcknowledgementItemProc:
   ...
   FOR EACH SOOrderItems WHERE
       ...
       chWorkSheet:Range("K" + STRING(nRow + LineCounter + 19) + ":" + "N" + STRING(nRow + LineCounter + 19 )):MergeCells = TRUE.
       chWorkSheet:Range("K" + STRING(nRow + LineCounter + 19) + ":" + "N" + STRING(nRow + LineCounter + 19 )):WRAPTEXT = TRUE.
       chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19) + ":" + "Q" + STRING(nRow + LineCounter + 19 )):MergeCells = TRUE.
       chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19) + ":" + "Q" + STRING(nRow + LineCounter + 19 )):WRAPTEXT = TRUE.
       chWorkSheet:Range("F" + STRING(nRow + LineCounter + 19) + ":" + "R" + STRING(nRow + LineCounter + 19)):HorizontalAlignment = "3".
       chWorkSheet:Range("J" + STRING(nRow + LineCounter + 19) + ":" + "R" + STRING(nRow + LineCounter + 19)):HorizontalAlignment = "1".
   ...
   /****************************************GST DETAIL**************************************************************/
       FOR FIRST TempProductGST WHERE
           ...
           chWorkSheet:Range("O" + STRING(nRow + LineCounter + 19)):VALUE = TRIM(STRING(localGstRate,">>9%")).
           chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19)):VALUE = TRIM(STRING(TaxAmount,">>>,>>>,>>9.99")).
           chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19)):NumberFormat = "###,###,##0.00". 
...
/***********Total Line********************************/   
   ...
   chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19)):VALUE = TRIM(STRING(localTotalTaxableAmount,">>>,>>>,>>9.99")).
   chWorkSheet:Range("H" + STRING(nRow + LineCounter + 19)):VALUE = TRIM(STRING(localTotalQuantity,">>>,>>>,>>9.99")).
   chWorkSheet:Range("H" + STRING(nRow + LineCounter + 19)):NumberFormat = "###,###,##0.00".
   chWorkSheet:Range("P" + STRING(nRow + LineCounter + 19)):VALUE = STRING(TotalTaxAmount,">>>,>>>,>>9.99").
...
PROCEDURE PrintMiscellaneousChargesProc:
  ...
  FOR EACH TempMiscellaneousGST WHERE
      ...
      chWorkSheet:Range("R" + STRING(nRow + LineCounter + 19)):HorizontalAlignment = "1".
